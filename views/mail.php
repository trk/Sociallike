						...
						<tr>
							<td>
								...
								<p>
									...
									<ion:field name="firstname" from_post_data="contact" />
								</p>
								<p>
									<strong><ion:translation term="module_simpleform_field_lastname" /></strong> : 
									<ion:field name="lastname" from_post_data="contact" />
								</p>
								<p>
								...
								<p>
									<strong><ion:translation term="module_simpleform_field_subject" /></strong> : 
									<ion:field name="subject" from_post_data="contact" />
								</p>
								<p>
